...
Config = {
    ...
    RagdollKeybind = 'o', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/.
	...
	CheckForUpdates = false, -- This is set to false by default and will check for any future updates on the official RPEmotes repository by TayMcKenzieNZ, as intended.
